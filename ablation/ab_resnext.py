...
class Inception(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.branch1 = REBNCONV(mid_channel, mid_channel, kernel_size=1)
        self.branch1_1 = REBNCONV(mid_channel, mid_channel, kernel_size=3)

        self.branch2 = REBNCONV(mid_channel, mid_channel, kernel_size=1)
        self.branch2_1 = REBNCONV(mid_channel, mid_channel, kernel_size=3)

        self.branch3 = REBNCONV(mid_channel, mid_channel, kernel_size=1)
        self.branch3_1 = REBNCONV(mid_channel, mid_channel, kernel_size=3)

        self.branch4 = REBNCONV(mid_channel, mid_channel, kernel_size=1)
        self.branch4_1 = REBNCONV(mid_channel, mid_channel, kernel_size=3)
    ...
    def forward(self, x):
        ...
        # 4条路径进行融合
        cats = [branch1, branch2, branch3, branch4]  # cats包含来自4条路径的4个特征图，他们具有相同的高度和宽度，不同的通道数
